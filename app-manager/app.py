...
Interface : icone CodeLab en haut a gauche de la barre laterale (reductible
via un bouton dedie, etat persiste en localStorage). Compte = icone de
profil generique en haut a droite, menu deroulant (Parametres /
Deconnexion) puis page dediee complete. Grille Projets sans etat "aucun
projet" -- juste la tuile "Nouveau projet".
"""
import json
import os
import re
