...
Interface : cartes projet compactes style icone iOS (grille) ou lignes
(liste), bascule via deux boutons dans la barre d'outils, preference
retenue en localStorage. Repli de la barre laterale anime en douceur
(cubic-bezier, fondu du texte plutot qu'un display:none brutal).
"""
import json
import os
import re
