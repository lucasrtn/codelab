...
Interface : plus d'onglet Logs separe. Cartes projet minimales (icone +
nom uniquement, clic = ouvre le site dans un nouvel onglet), menu "..."
par carte (Modifier / Activer-Desactiver / Voir les logs / Supprimer).
Modifier et Voir les logs s'ouvrent tous deux en pop-up centree (modal).
"""
import json
import os
import re
