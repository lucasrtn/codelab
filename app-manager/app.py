...
Parametres) plutot qu'une barre d'onglets en haut. Parametres est une page
dediee (apparence + deconnexion), plus de menu compte deroulant ni de
commande de copie des identifiants dans l'interface -- credentials.env
suffit, lisible directement depuis le disque.
"""
import json
import os
import re
